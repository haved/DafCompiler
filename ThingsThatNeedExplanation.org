...
** Functions and defs
When parsing defs with parameter lists and return values, the function signature syntax is used.
This code is also used when parsing def function types and normal function types.
